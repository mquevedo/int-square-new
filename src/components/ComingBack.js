      ...
      <div id="coming-back" className="coming-back">
        ...
        <div className="coming-back__items row justify-content-center">
          <div className="coming-back__item col-sm-12 col-lg-4">
            <img className="coming-back__item__image coming-back__item__image--right" src={`${process.env.PUBLIC_URL}/images/comingback-korinver.svg`} alt="korinver"/>
          ...
          <div className="coming-back__item col-sm-12 col-lg-4">
            <img className="coming-back__item__image" src={`${process.env.PUBLIC_URL}/images/comingback-work.svg`} alt="workremotely"/>
          ...
          <div className="coming-back__item col-sm-12 col-lg-4">
            <img className="coming-back__item__image" src={`${process.env.PUBLIC_URL}/images/comingback-startup.svg`} alt="startup"/>
